...
//
package com.example.__mytest.adapter
...
import com.example.__mytest.type.adapter.LifeStatus_ResponseAdapter
    ...
    private object Something : Adapter<TestOperation.Data.Something> {
      ...
      public override fun fromJson(reader: JsonReader, customScalarAdapters: CustomScalarAdapters):
        ...
        if (possibleTypes("Human").evaluate(customScalarAdapters.adapterContext.variables(), __typename, customScalarAdapters.adapterContext, null)) {
          reader.rewind()
          _onHuman = com.example.__mytest.adapter.TestOperation_ResponseAdapter.Data.Something.OnHuman.fromJson(reader,
        ...
        if (possibleTypes("Human","Human2","Droid").evaluate(customScalarAdapters.adapterContext.variables(), __typename, customScalarAdapters.adapterContext, null)) {
          reader.rewind()
          _onThingWithName = com.example.__mytest.adapter.TestOperation_ResponseAdapter.Data.Something.OnThingWithName.fromJson(reader,
              customScalarAdapters)
        }
      ...
      public override fun toJson(
        ...
        if (value.onHuman != null) {
          com.example.__mytest.adapter.TestOperation_ResponseAdapter.Data.Something.OnHuman.toJson(writer,
              customScalarAdapters, value.onHuman)
        }

        if (value.onThingWithName != null) {
          com.example.__mytest.adapter.TestOperation_ResponseAdapter.Data.Something.OnThingWithName.toJson(writer,
      ...
      private object OnHuman : Adapter<TestOperation.Data.Something.OnHuman> {
        ...
        private object Friend : Adapter<TestOperation.Data.Something.OnHuman.Friend> {
          ...
          public override fun fromJson(reader: JsonReader,
            ...
            if (possibleTypes("Human").evaluate(customScalarAdapters.adapterContext.variables(), __typename, customScalarAdapters.adapterContext, null)) {
              reader.rewind()
              _onHuman = com.example.__mytest.adapter.TestOperation_ResponseAdapter.Data.Something.OnHuman.Friend.OnHuman.fromJson(reader,
                  customScalarAdapters)
            }
            ...
            if (possibleTypes("Human2").evaluate(customScalarAdapters.adapterContext.variables(), __typename, customScalarAdapters.adapterContext, null)) {
              reader.rewind()
              _onHuman2 = com.example.__mytest.adapter.TestOperation_ResponseAdapter.Data.Something.OnHuman.Friend.OnHuman2.fromJson(reader,
                  customScalarAdapters)
            }
          ...
          public override fun toJson(
            ...
            if (value.onHuman != null) {
              com.example.__mytest.adapter.TestOperation_ResponseAdapter.Data.Something.OnHuman.Friend.OnHuman.toJson(writer,
                  customScalarAdapters, value.onHuman)
            }

            if (value.onHuman2 != null) {
              com.example.__mytest.adapter.TestOperation_ResponseAdapter.Data.Something.OnHuman.Friend.OnHuman2.toJson(writer,
      ...
      private object OnThingWithName : Adapter<TestOperation.Data.Something.OnThingWithName> {
        public val RESPONSE_NAMES: List<String> = listOf("name")
