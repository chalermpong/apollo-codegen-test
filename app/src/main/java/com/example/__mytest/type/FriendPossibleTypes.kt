...
/**
 * Auto generated enum class for enumerable possible type of Friend
 */
public enum class FriendPossibleTypes(
  ...
  public companion object {
    public fun safeValueOf(rawValue: String): FriendPossibleTypes =
